<?php
/**
 * Template part for displaying a single interview.
 *
...
$source = get_post_meta( $post->ID, '_bufu_artist_interview_source', true);
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <header class="entry-header">
                ...
                <p class="album-meta"><?php if (!empty($source)) echo esc_html($source) ?></p>
            </header><!-- .entry-header -->
