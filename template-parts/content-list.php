<?php
/**
 * Template part for displaying post list item.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php endif; ?>
            ...
            <footer class="entry-footer">
                <a href="<?php echo esc_url( $permalink ) ?>" title="<?php echo esc_attr( $postTitle ) ?>" class="btn btn-icon-left"><span class="icon">&raquo;</span> <?php echo __('Read more', 'bufu-theme') ?></span></a>
