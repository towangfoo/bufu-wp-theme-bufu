...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'bufu-theme' ),
            //'description' => __( 'This is a section for the typography', 'bufu-theme' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'bufu-theme' ),
        'section'    => 'typography',
        'settings'   => 'theme_option_setting',
        'type'    => 'select',
        'choices' => array(
            'default' => 'Default',
			'bufu'     => 'BuschFunk Theme',
        )
    ) ) );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'bufu-theme' ),
        'section'    => 'typography',
        'settings'   => 'preset_style_setting',
        'type'    => 'select',
        'choices' => array(
            'default' => 'Default',
			'worksans-ibmplexsans' => 'BuschFunk Theme [Work Sans / IBM Plex Sans]',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_color_scheme_setting', array(
        'label' => __( 'Color Scheme', 'bufu-theme' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'bufu-theme' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'bufu-theme' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'bufu-theme' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize',
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'bufu-theme' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'bufu-theme'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'bufu-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'bufu-theme' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'bufu-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'bufu-theme' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'bufu-theme' ),
            //'description' => __( 'This is a section for the header banner Image.', 'bufu-theme' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'cdn_assets_setting', array(
        'default' => __( 'no','bufu-theme' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'bufu-theme' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'bufu-theme' ),
            'section' => 'site_name_text_color',
            'settings' => 'cdn_assets_setting',
	        'type'    => 'select',
	        'choices' => array(
	            'yes' => __( 'Yes', 'bufu-theme' ),
	            'no' => __( 'No', 'bufu-theme' ),
        	)
        )
    );
