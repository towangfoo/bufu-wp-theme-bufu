...
function wp_bootstrap_starter_setup() {
	 ...
	 */
	load_theme_textdomain( 'bufu-theme', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'bufu-theme' ),
		'footer'  => esc_html__( 'Footer', 'bufu-theme' ),
	) );
...
function wp_bootstrap_starter_widgets_init() {
    register_sidebar( array(
        'name'          => esc_html__( 'Posts sidebar', 'bufu-theme' ),
        'id'            => 'sidebar-1',
        'description'   => esc_html__( 'Sidebar shown with the list of posts', 'bufu-theme' ),
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Sidebar', 'bufu-theme' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Sidebar in the page footer. Currently unused.', 'bufu-theme' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
        'before_title'  => '<h3 class="widget-title">',
        'after_title'   => '</h3>',
...
function wp_bootstrap_starter_scripts() {
	...
	if(get_theme_mod( 'preset_style_setting' ) === 'worksans-ibmplexsans') {
		wp_enqueue_style( 'wp-bootstrap-starter-worksans-ibmplex-font', 'https://fonts.googleapis.com/css2?family=IBM+Plex+Sans&family=Work+Sans:wght@200;400;500;700;800' );
	}
...
function wp_bootstrap_shortcode_newsletter_signup( $atts, $content, $shortcode_tag ) {
	ob_start();
	get_template_part( 'shortcodes/newsletter-signup', null, $atts );
	return ob_get_clean();
}

function wp_bootstrap_shortcode_newsletter_sidebar( $atts, $content, $shortcode_tag ) {
	ob_start();
	get_template_part( 'shortcodes/newsletter-sidebar' );
	return ob_get_clean();
}
