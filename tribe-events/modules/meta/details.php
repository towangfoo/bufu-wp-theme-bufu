...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<dl>
		...
		// Event Website
		if ( ! empty( $website ) ) :
			$websiteURL = tribe_get_event_website_url();
            ?>
            <a href="<?php echo $websiteURL; ?>" target="_blank" class="btn btn-default btn-pill"><?php esc_html_e( 'Order tickets', 'bufu-theme' ); ?></a>
		<?php endif ?>
